...
int sc_main(int arg_num, char *arg_vet[]) {
	...
	cout << "\t\t(C) University of Catania, University of Turku" << endl
			<< endl;
	...
	cout << " ( " << sc_time_stamp().to_double() / 1000 << " cycles executed)"
			<< endl;
	...
	if ((NoximGlobalParams::max_volume_to_be_drained > 0)
		...
		cout << "\nWARNING! the number of flits specified with -volume option"
				<< endl;
		cout << "has not been reached. ( " << drained_volume << " instead of "
				<< NoximGlobalParams::max_volume_to_be_drained << " )" << endl;
		cout << "You might want to try an higher value of simulation cycles"
				<< endl;
